...
async def get_thumb(videoid):
    try:
        ...
        if 1 == 1:
            ...
            circle = Image.open("ZelzalMusic/assets/LORD.png")
            ...
            # fonts
            font1 = ImageFont.truetype("ZelzalMusic/assets/font2.ttf", 30)
            font2 = ImageFont.truetype("ZelzalMusic/assets/font2.ttf", 70)
            font3 = ImageFont.truetype("ZelzalMusic/assets/font2.ttf", 40)
            font4 = ImageFont.truetype("ZelzalMusic/assets/font2.ttf", 35)

            image4 = ImageDraw.Draw(image2)
            image4.text(
                (10, 10), " Source Eirthon", fill="white", font=font1, align="left"
            )
            image4.text(
                (670, 150),
                "LORD PlAYiNg",
