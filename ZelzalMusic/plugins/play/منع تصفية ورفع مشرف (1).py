...
@app.on_message(filters.command("رفع لورد", "") & filters.channel)
def promote_c_admin(client, message):
    ...
    message.reply(f"تم رفع {user_id} لورد بنجاح")
    



@app.on_message(filters.command("رفع لورد", "") & filters.group)
